...
RESULTS_FILE = os.path.join(
    RESULTS_DIR,
    "final_test_candidate_results.csv",
)
...
def main():
    ...
    print("=" * 70)
    print("PEARLSAQI FINAL V4 TEST-SET EVALUATION")
    print("=" * 70)
    ...
    #
    # NOTE:
    # We calculate them independently for each dataset.
    ...
    for feature in all_features:
        ...
        if feature not in test.columns:
            raise RuntimeError(
                f"Test missing feature: {feature}"
            )
    ...
    # --------------------------------------------------------
    #
    # We intentionally DO NOT use validation here.
    #
    # Candidate selection was performed using validation.
    # This test set is now used only for final comparison.
    #
    # --------------------------------------------------------
    ...
    print()
    print("=" * 70)
    print("CURRENT PRODUCTION V007 REFERENCE")
    print("=" * 70)
    ...
    # --------------------------------------------------------
    # Delta versus production
    # --------------------------------------------------------

    print()
    print("=" * 70)
    print("BEST CANDIDATE VS V007")
    print("=" * 70)

    print(
        f"RMSE delta : "
        f"{best['rmse'] - production_rmse:+.4f}"
    )

    print(
        f"MAE delta  : "
        f"{best['mae'] - production_mae:+.4f}"
    )

    print(
        f"R2 delta   : "
        f"{best['r2'] - production_r2:+.4f}"
    )
    ...
    print("IMPORTANT:")
    print(
        "No production model or registry files "
        "were modified."
    )
